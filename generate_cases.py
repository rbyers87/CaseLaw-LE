...
categories_config = [
    {
        ...
        "icon": "🚗",
        "cases": ["whren-v-us", "carroll-v-us", "arizona-v-gant", "pennsylvania-v-mimms", "maryland-v-wilson"]
    },
    {
...
case_data = [
    ...
    # ... (copy ALL the other 20 case dictionaries here from your current file)
    # I'm truncating for brevity – make sure you keep all 21 entries.
]
